...
const Navbar = () => {
  ...
  return (
    <div className="w-full h-full shadow-lg p-4 flex items-center justify-between">
      ...
      <button onClick={handleLogout} className="px-6 py-2 font-semibold text-white bg-blue-500 rounded hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
        Logout
    </button>
    </div>
  );
